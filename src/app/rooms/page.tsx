  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div>
          <h1 className="text-xl font-bold text-slate-100">Household Rooms</h1>
        ...
        {rooms.map((room) => {
          ...
          return (
            <Link key={room.id} href={`/rooms/${room.id}`}>
              <Card className="hover:border-slate-700 hover:bg-slate-900/80 transition-all cursor-pointer h-full flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <DoorOpen className="w-4 h-4 text-sky-400" />
                      <span className="text-sm font-bold text-slate-100">{room.name}</span>
                    </div>
